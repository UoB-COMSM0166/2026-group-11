...
|------------|-------|-------------|
| Archery Tower Level 1 |<img width="457" height="657" alt="tower2" src="https://github.com/user-attachments/assets/af7b8802-013b-4be1-9a71-cbdbf7a21c98" /> | This is the cheapest offensive tower, costing only **70 gold**. It deals **10 physical damage**, attacks every **30 frames**, and has a **range of 400**, so it is mainly used to establish an early defence quickly. |
| Archery Tower Level 2 |<img width="424" height="433" alt="tower2_lv2" src="https://github.com/user-attachments/assets/64488e59-daf5-40e7-a7b4-65a21d1a7706" /> | After an upgrade costing **110 gold**, the tower’s range increases to **500**, its damage rises to **15**, and its fire rate improves to **20 frames per attack**. This makes it much more reliable against stronger early- and mid-game enemies. |
| Archery Tower Level 3 |<img width="424" height="433" alt="tower2_lv3" src="https://github.com/user-attachments/assets/3d6633f6-868a-432c-a6c1-6ab3a27cf6ce" />| At its highest level, the Archery Tower reaches **600 range**, attacks every **10 frames**, and deals **20 physical damage**. Although it remains a single-target tower, its fast attack speed makes it very effective for sustained damage output. |
| Magic Tower Level 1 | <img width="414" height="427" alt="tower1" src="https://github.com/user-attachments/assets/8abc3787-0faa-4eed-9885-ba528511cecd" /> | The Magic Tower costs **100 gold** and deals **25 magic damage** every **45 frames** within a **range of 400**. Because it uses magic damage, it gives the player an early answer to enemies with stronger physical defence. |
| Magic Tower Level 2 | <img width="424" height="433" alt="tower1_lv2" src="https://github.com/user-attachments/assets/186a34c6-0836-46db-bd9e-13a3115ab420" /> | With a further **160 gold** upgrade, the tower improves to **40 magic damage**, **450 range**, and **40 frames per attack**. This upgrade gives it a more dependable role against armoured enemies. |
| Magic Tower Level 3 | <img width="424" height="433" alt="tower1_lv3" src="https://github.com/user-attachments/assets/f8a1befc-ccd3-4f31-bc4d-634bc669dcc7" /> | The final upgrade costs **240 gold** and raises the tower to **60 magic damage** with a **500 range** and a **35-frame fire rate**. At this level, it becomes one of the strongest options for dealing with enemies that resist physical attacks. |
| Cannon Tower Level 1 | <img width="457" height="657" alt="tower3" src="https://github.com/user-attachments/assets/2e983e7e-37fd-4259-89b4-f363c50ea82b" />| The Cannon Tower is the most expensive basic tower at **125 gold**, but it offers area damage from the start. It deals **35 damage**, attacks every **65 frames**, and affects enemies within a **100 splash radius**, making it useful against clustered waves. |
| Cannon Tower Level 2 | <img width="424" height="433" alt="tower3_lv2" src="https://github.com/user-attachments/assets/3aba1165-7714-46e1-835f-98dd3ed498c1" /> | After a **220 gold** upgrade, its damage rises to **55**, the attack range becomes **440**, and the splash radius expands to **125**. This gives the player a much better tool for controlling larger groups of ground enemies. |
| Cannon Tower Level 3 | <img width="424" height="433" alt="tower3_lv3" src="https://github.com/user-attachments/assets/91f1fef5-ac80-4c26-b505-00a5a1b5807b" /> | Once fully upgraded, the Cannon Tower deals **80 area damage** with a **150 splash radius**, attacks every **55 frames**, and reaches **480 range**. It is especially effective when dense enemy waves move through narrow parts of the path. |
| Ice Tower Level 1 | <img width="424" height="433" alt="tower4" src="https://github.com/user-attachments/assets/46b11b34-2670-4f40-bcfe-4bf9d5af13f3" /> | The Ice Tower costs **70 gold** and works mainly as a support tower. Although it deals only **5 magic damage**, it attacks every **40 frames** and slows enemies to **50% of their normal speed** for **70 frames**, giving other towers more time to attack. |
| Ice Tower Level 2 | <img width="424" height="433" alt="tower4_lv2" src="https://github.com/user-attachments/assets/6885c8f2-7272-435b-aec9-5467cc970043" /> | With an upgrade cost of **110 gold**, the tower improves to **7 magic damage**, **500 range**, and a stronger slow effect that reduces enemies to **40% speed** for **90 frames**. It becomes much more useful against fast-moving enemies. |
| Ice Tower Level 3 | <img width="424" height="433" alt="tower4_lv3" src="https://github.com/user-attachments/assets/b867bacc-1abd-4cdb-912a-d5a9857e8678" /> | The final Ice Tower upgrade costs **220 gold**. At this stage it reaches **600 range**, attacks every **25 frames**, deals **10 magic damage**, and slows enemies to **30% speed** for **120 frames**. This makes it a strong late-game control tower during difficult waves. |
